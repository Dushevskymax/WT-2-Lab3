...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("Can't find server on such port");
        } catch (UnknownHostException e) {
            System.out.println("Can't find such host");
        } catch (SocketException e) {
            System.out.println("Here's problem with creating user socket");
        }
