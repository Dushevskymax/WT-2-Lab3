...
import com.lab.archive.dao.impl.UserDAOImpl;
import com.lab.archive.repository.impl.UserRepositoryImpl;
import com.lab.archive.service.UserService;
import com.lab.archive.service.impl.UserServiceImpl;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            System.out.println("This port is already used, try another one");
        }
    }
